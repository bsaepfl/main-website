    ...
    return(
        <div className='flex flex-col w-full h-full bg-dark-100 pb-32'>
            <div className='flex flex-col lg:flex-row text-centre items-center justify-around gap-10 lg:gap-0 pt-20 w-full px-0 xl:px-10 2xl:px-20'>
                <Image alt="education logo" className='pt-10' src= {edulogo} width={300} height={300}></Image>
            ...
            <div className='flex flex-col items-center py-20 w-full'>
                <button onClick={(e) => {e.preventDefault();
                    ...
                    <div className='flex flex-row items-center'>
                        <Image alt="github" className='w-24 pr-6' src={github} width={100} height={100}></Image> 
                ...
                <button onClick={(e) => {e.preventDefault();
                    ...
                    <div className='flex flex-row items-center'>
                            ...
                            <Image alt="telegram" className='w-20 pl-4' src = {telegram} width={100} height={100}></Image> 
                    </div>
                ...
                <button onClick={(e) => {e.preventDefault();
                    ...
                    <div className='flex flex-row items-center'>
                            <Image alt="discord" className='w-24 pr-4' src = {discord} width={100} height={100}></Image> 
                ...
                <button onClick={(e) => {e.preventDefault();
                    ...
                    <div className='flex flex-row items-center'>    
                        ...
                        <Image alt="solidity" className='pl-6 w-16' src = {solidity} width={100} height={100}></Image>
                    </div>
